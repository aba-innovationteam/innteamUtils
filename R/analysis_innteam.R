...
analysis_innteam = function(path, ...) {
  ...
  readme = c(paste0("# ", ProjectName, "  "),
        ...
        paste("Documents     |  contains the background information provided ",
              ...
              "DataRaw       |  contain all raw data provided by the client and from other sources",
              "DataProcessed |  contains the processed data used for analysis",
              "DataOutput    |  contains the output data used for analysis",
        paste("Deliverables  |  contains any materials produced for",
              "final delivery, ie. Slides, notes, abstracts"),
