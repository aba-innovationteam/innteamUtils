...
The `innteamUtils` offers a collection of functions themes and datasets to enhance productivity on daily coding and reproducibility throughout the organization. 
...
- **Visualization**:   
    ...
    - `bslib` for Shiny apps: **TBD**, probably a template with theme options. 
- **Reporting**:  
